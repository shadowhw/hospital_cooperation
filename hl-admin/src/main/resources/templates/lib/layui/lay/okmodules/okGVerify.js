layui.define(["jquery"], function (exprots) {
    ...
    function GVerify(options) {
        ...
        this.options.numArr = "2,3,4,5,8".split(",");//剔除0 1 7 6 9
    ...
    function getAllLetter() {
        var letterStr = "a,c,e,f,g,h,j,k,m,n,p,r,s,t,u,w,x,z,A,B,C,E,F,G,H,J,K,M,N,P,Q,R,S,T,U,V,W,X,Y,Z";//剔除i I l L o O d D y v q b
